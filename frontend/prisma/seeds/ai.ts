...
export async function seedAiData(userId: string, projectId: string) {
    ...
    data: [
      {
        ...
        role: "user",
        content:
          "Analyse le SPI du projet Usine Bouskoura et donne-moi des recommandations.",
      },
      {
        conversationId: conversation.id,
        role: "assistant",
      ...
      },
      {
        ...
        role: "user",
        content:
          "Génère un PV de réunion pour la réunion chantier de ce matin.",
      },
      {
        conversationId: conversation.id,
        role: "assistant",
        content:
          `## PV — Réunion de Chantier | Usine Bouskoura | ${new Date().toLocaleDateString(
            "fr-FR"
          )}\n\n` +
          "**1. PARTICIPANTS**\n" +
  ...
  const DEMO_ALERTS = [
    {
      type: "DELAY_RISK" as const,
      level: "CRITICAL" as const,
      message:
        "Retard critique prédit : +46 jours sur Usine Bouskoura",
      value: "+46j",
      confidence: 88,
    },
    {
      ...
      level: "CRITICAL" as const,
      message:
        "Dépassement budgétaire Station Énergie — EAC 283M vs BAT 210M (+34.8%)",
      value: "+34.8%",
      confidence: 91,
    },
    {
      ...
      level: "HIGH" as const,
      message:
        "Consommation béton anormale Zone C — ×1.34 vs norme",
      value: "×1.34",
      confidence: 84,
    },
    {
      type: "HSE_RISK" as const,
      level: "MEDIUM" as const,
      message:
        "Taux de fréquence incidents HSE en hausse — TF = 8.5",
      value: "TF=8.5",
      confidence: 78,
    },
    {
      type: "NC_BLOCKAGE" as const,
      level: "HIGH" as const,
      message:
        "4 non-conformités ouvertes bloquant l'avancement",
      value: "4 NC",
      confidence: 95,
    },
  ]
  ...
  await prisma.aiMemory.upsert({
    ...
    create: {
      ...
      key: "preferred_language",
      value: "fr",
      context: "Langue préférée de l'utilisateur",
    },
  })
  ...
  await prisma.aiMemory.upsert({
    ...
    create: {
      ...
      key: "last_project",
      value: projectId,
      context: "Dernier projet consulté",
    },
  })
