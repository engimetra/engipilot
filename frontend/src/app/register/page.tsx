...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const validationError = validate(prenom, nom, email, password, companyName)
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" value={prenom} onChange={e => setPrenom(e.target.value)}
                      placeholder="Karim" autoComplete="given-name"
                      className="w-full border border-gray-200 rounded-xl px-4 py-3 pl-9 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" />
                  </div>
                </div>
                <div>
                  <label className="text-sm font-semibold text-gray-700 block mb-1.5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" value={companyName} onChange={e => setCompanyName(e.target.value)}
                    placeholder="BATIMAX Maroc" autoComplete="organization"
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 pl-9 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 pl-9 pr-10 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all"
                  />
