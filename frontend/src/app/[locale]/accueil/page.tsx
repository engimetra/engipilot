        ...
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-3 gap-6 items-start">
            {[
              ...
              <div
                key={plan.name}
                className={`relative rounded-2xl border overflow-hidden transition-all hover:-translate-y-1 ${
              ...
              >
                {plan.highlight && (
                  <>
                    ...
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-orange-500 text-white text-xs font-bold px-4 py-1 rounded-full shadow-md">
                      LE PLUS POPULAIRE
                    </div>
                  </>
                )}
                <div className="relative p-7 flex flex-col gap-5">
                  <div>
                    <h3 className={`text-xl font-black ${plan.highlight ? "text-white" : ""}`}>{plan.name}</h3>
