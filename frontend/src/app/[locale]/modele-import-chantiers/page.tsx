...
const COLUMNS = [
  ...
  { key: "client",           label: "Client",            required: true,  type: "Texte",   example: "Maître Ouvrage SA", desc: "Nom du maître d'ouvrage" },
  ...
  { key: "chef_projet",      label: "Chef de Projet",    required: true,  type: "Texte",   example: "Chef Projet",    desc: "Nom du chef de projet responsable" },
  { key: "chef_chantier",    label: "Chef de Chantier",  required: false, type: "Texte",   example: "Chef Chantier",    desc: "Nom du chef de chantier terrain" },
...
const SAMPLE_ROWS = [
  ["CH-2024-001", "Résidence Exemple", "Client A", "Résidentiel", "Casablanca", "Grand Casablanca", "01/03/2024", "31/12/2025", "15000000", "35", "Chef Projet", "Chef Chantier", "En cours", "0.92", "0.88", "Construction R+7 avec parking sous-sol"],
  ["CH-2024-002", "Projet Industriel B", "Client B", "Industriel", "Bouskoura", "Grand Casablanca", "15/01/2024", "30/06/2025", "42000000", "58", "Chef Projet", "Chef Chantier", "En cours", "0.72", "0.95", "Unité de production 5000m²"],
  ["CH-2024-003", "Infrastructure Exemple", "Client C", "Infrastructure", "Mohammedia", "Grand Casablanca", "01/06/2024", "31/05/2026", "210000000", "12", "Chef Projet", "", "Planifié", "", "", "Station haute tension 225kV"],
]
